...
if (myAccountId == null || myPrivateKeyString == null) {
...
if (recipientAccountId == null || recipientPrivateKeyString == null) {
...
const recipientWallet = new Wallet(recipientAccountId, recipientPrivateKey);
